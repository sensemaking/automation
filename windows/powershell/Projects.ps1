...
function global:Get-Projects {
    return @{ 
        ...
        [Project]::PopulationHealth = [PSCustomObject]@{ Git = "git@github.com:sensemaking/population-health.git"; Directory = "~\population-health"; Script = $null; VsSolution = "~\population-health\PopulationHealth.sln"; CodeSolution = $null; HasJs = $false; };
    }
}
