...
function global:Get-Projects {
    return @{ 
        ...
        [Project]::PopulationAnalytics = [PSCustomObject]@{ Git = "git@github.com:HearstHealthInternational/population-analytics.git"; Directory = "~\population-analytics"; Script = $null; VsSolution = "~\population-analytics"; CodeSolution = $null; HasJs = $false; };
