...
function global:Get-Projects {
    return @{ 
        ...
        [Project]::Authoring = [PSCustomObject]@{Directory = "~\fdb-rx-authoring"; IncludesNetFrameworkProjects = $true; HasJs = $false; VsSolution = "~\fdb-rx-authoring\Authoring.sln"; Script = $null; Git = "git@github.com:HearstHealthInternational/fdb-rx-authoring.git" };
