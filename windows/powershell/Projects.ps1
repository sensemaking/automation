...
function global:Get-Projects {
    return @{ 
        ...
        [Project]::FdbProvisioning = [PSCustomObject]@{ Git = "git@github.com:HearstHealthInternational/fdb-population-health.git"; Directory = "~\fdb-population-health"; Script = $null; VsSolution = $null; CodeSolution = $null; HasJs = $false; };
    }
}
