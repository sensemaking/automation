...
function global:Get-Projects {
    return @{ 
        ...
        [Project]::Pharaoh = [PSCustomObject]@{Directory = "~\fdb-rx-authoring"; IncludesNetFrameworkProjects = $true; HasJs = $true; CodeSolution = "~\fdb-rx-authoring\Pharaoh\UI\client"; VsSolution = "~\fdb-rx-authoring\Authoring.sln"; Script = $null; Git = "git@github.com:HearstHealthInternational/fdb-rx-authoring.git" };
