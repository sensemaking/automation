...
function global:Get-Projects {
    return @{ 
        ...
        [Project]::FdbWeb = [PSCustomObject]@{ Git = "git@github.com:HearstHealthInternational/fdb-rx-web.git"; Directory = "~\fdb-rx-web"; Script = $null; VsSolution = "~\fdb-rx-web\Web.sln"; CodeSolution = $null; HasJs = $false; };        
